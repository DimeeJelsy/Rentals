          ...
          <form role="form" metohd="post">
            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                <div class="form-group row nuevoProducto" style="background:green; color:white">
                ...
                <button type="button" style="background:green; color:white" class="btn btn-default hidden-lg">Agregar producto</button>
            ...
            <table class="table table-bordered table-striped dt-responsive tablas">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>                 
                    <div class="btn-group">
                      <button type="button" class="btn btn-primary"  color:white">Agregar</button> 
                    </div>
                  </td>
                </tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-body" style="background:green; color:white">
