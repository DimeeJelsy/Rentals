  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarProducto"  style="background:green; color:white">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:green; color:white">
          ...
          <button type="button" class="close" data-dismiss="modal"  style="background:green; color:white">&times;</button>
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <img src="vistas/img/productos/default/anonymus.jpg" class="img-thumbnail previsualizar" width="100px">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary"  style="background:green; color:white">Guardar producto</button>
