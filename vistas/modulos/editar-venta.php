              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-addon"><button type="button" style="background-color: green;" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modalAgregarCliente" data-dismiss="modal">Agregar cliente</button></span>
                ...
                <button type="button" style="background-color: green;" class="btn btn-default hidden-lg btnAgregarProducto">Agregar producto</button>
