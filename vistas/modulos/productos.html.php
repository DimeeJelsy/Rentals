      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas">
        ...
        <tbody>
          ...
          <tr>
            <td>1</td>
            <td><img src="vistas/img/productos/default/anonymus.png" class="img-thumbnail" width="40px"></td>
            <td>0001</td>
       ...
       <div class="form-group">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <img src="vistas/img/productos/default/anonymus.png" class="img-thumbnail" width="100px">
