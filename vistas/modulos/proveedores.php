  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarProveedor" style="background-color: green;">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary"  style="background:green; color:white">Guardar Proveedor</button>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" style="background:green">Guardar cambios</button>
