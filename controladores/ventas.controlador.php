		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta == "ok"){
				...
				if(isset($_POST["impresion"])){
					...
					$printer -> text("Lemars Rentals Services,C.A"."\n");//Nombre de la empresa

					$printer -> text("Rif:J-31047644-6"."\n");//Rifde la empresa

					$printer -> text("Dirección: Av, Alirio Ugarte Pelayo, entre Fervenca y Covencaucho"."\n");//Dirección de la empresa

					$printer -> text("Teléfono: 0414-7658151"."\n");//Teléfono de la empresa
